...
public class Otp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ms=getIntent().getExtras().getString("otp");
        rol=getIntent().getExtras().getString("rollNo");
    ...
    verify.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            otpBut=otp.getText().toString();
            new Verify().execute(rol,otpBut);
        }
    });
    ...
    private class Verify extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                URL url = new URL("http://" + MainActivity.base + "/verify");
        ...
        protected void onPostExecute(String mm) {
            ...
            else
            {
                try{
                    ...
                    String fname=jk.getString("first_name");
                    String roll=jk.getString("roll_no");
                    ...
                    editor.commit();
                    Intent s=new Intent(Otp.this,Register.class);
                   // store in local preference
                    s.putExtra("id",id);
